...
if(isset($_POST['nom'])){
  ...
  $stade= $_POST['motpass'];
  $logo= $_POST['email'];
  $query = "UPDATE `compte` SET `login` = '$nom', `motpass` = 'potpass', `email` = 'email' WHERE `compte`.`login` = '$id' ";
    ...
    <section class="content container-fluid">
      <form method="post" target="equipe-edit.php">
          <table class="table table-inverse">
            <tr>  <th>Nom Utlisateur</th> <td><input type="text" name="nom" ></td></tr>
            <tr>  <th>Mot De Passe</th><td><input type="text" name="motpass" ></td>  </tr>
