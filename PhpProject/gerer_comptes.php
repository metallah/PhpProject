  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
     ...
     <ol class="breadcrumb">
       ...
       <li class="active">Gerer Comptes</li>
     </ol>
   </section>
   <?php
   ...
   <section class="content">
     ...
     <table class="table table-inverse" id="ourtable">
       <thead><tr><th>Nom Util</th><th>mot de passe</th><th>Type</th><th>Activé/Desactivé</th><th>Email</th></tr></thead>
       <tbody>
         <?php
         foreach ($conn->query($q) as $line) {
           ...
           echo "<td> <a href='index.php?id=".$line[0]."'>  <img class='img imga' src='icons/edit.png'>&nbsp;&nbsp;</a> &nbsp <a href='comptes/Account-del.php?id=".$line[0]."'>  <img class='img imga' src='icons/del.png'>&nbsp;&nbsp;</a> </td>";
           echo "</tr>";
         }
         ?>
       </tbody>
     </table>
      <a href='comptes/Account-add.php'>
