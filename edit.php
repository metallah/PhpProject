...
if(isset($_POST['ref'])){
  ...
  $codeequipe= $_POST['CodeEquipe'];
$query = "UPDATE `joueur` SET `Nom` = '$nom', `Prenom` = '$prenom', `Datenaiss` = '$datenaiss', `Tel` = '$tel', `Email` = '$email', `Facebook` = '$facebook', `CodeEquipe` = '$codeequipe' WHERE `joueur`.`Nlin` = '$id' ";
